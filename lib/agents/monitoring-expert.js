...
exports.MonitoringExpertAgent = void 0;
class MonitoringExpertAgent {
    constructor() {
        this.id = 'monitoring-expert';
        this.name = 'Monitoring Expert Agent';
        this.description = 'Expert in system monitoring, observability, alerting, and performance tracking across distributed systems.';
        this.abilities = [
    ...
    async performMonitoringSetup(request) {
...
exports.MonitoringExpertAgent = MonitoringExpertAgent;
