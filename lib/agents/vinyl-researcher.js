...
exports.VinylResearcherAgent = void 0;
class VinylResearcherAgent {
    constructor() {
        this.id = 'vinyl-researcher';
        this.name = 'Vinyl Researcher';
        this.description = 'Lookup vinyl record info, prices, and metadata.';
        this.abilities = [
...
The research uses the Discogs API to provide accurate and up-to-date vinyl record data including pricing, condition guides, and market trends.`,
     ...
     */
    async executeVinylResearchTask(payload) {
        try {
     ...
     */
    async performVinylResearch(userRequest, payload) {
        try {
...
Vinyl research provides detailed record information for informed collecting and valuation decisions.`;
     ...
     */
    createVinylResearchPlan(request, payload) {
...
exports.VinylResearcherAgent = VinylResearcherAgent;
