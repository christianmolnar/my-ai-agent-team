...
exports.AI_CONFIG = {
    ...
    llm: {
        ...
        generateResponse: universal_ai_client_1.universalAIClient.generateResponse.bind(universal_ai_client_1.universalAIClient),
...
async function generateLLMResponse(agentId, messages, systemPrompt) {
    const response = await universal_ai_client_1.universalAIClient.generateResponse(agentId, messages, systemPrompt);
